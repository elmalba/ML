...
function DropCardSpace(props) {
  let status = (props.cardsIn > 0 && props.roundState !== 'viewing-winner') ? `${props.cardsIn} Cartas en` : ""
  // draggable
  ...
  // not draggable
    ...
    return (
      <div className="drop-space">
        <Card roundJudge={props.roundJudge} {...props.QCard} status={props.roundState !== 'judge-selecting' && status} />
      </div>
    );
  }
